...
if ($ADMIN->fulltree) {                                                                                                             
    ...
    $setting = new admin_setting_configtextarea('theme_eduhub/scsspre',                                                              
        get_string('rawscsspre', 'theme_eduhub'), get_string('rawscsspre_desc', 'theme_eduhub'), '', PARAM_RAW);                      
    $setting->set_updatedcallback('theme_reset_all_caches');                                                                        
    $page->add($setting);                                                                                                           
                                                                                                                                    
    // Raw SCSS to include after the content.                                                                                       
    $setting = new admin_setting_configtextarea('theme_eduhub/scss', get_string('rawscss', 'theme_eduhub'),                           
        get_string('rawscss_desc', 'theme_eduhub'), '', PARAM_RAW);                                                                  
    $setting->set_updatedcallback('theme_reset_all_caches');                                                                        
    $page->add($setting);                                                                                                           
