...
use lang_string;
use moodle_url;
use theme_eduhub\util\course;

/**
 *
 * @method string box($contents, $classes = 'generalbox', $id = null, $attributes = array())
 */
class course_renderer extends \core_course_renderer {
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        $data = [
            ...
            'summary' => shorten_text($courseutil->get_summary($chelper), 100),
        ...
        return $this->render_from_template('theme_eduhub/eduhub_coursecard', $data);
    }
    ...
    public function course_category($category) {
        ...
        // EDITED show courses type to be EXPANDED
