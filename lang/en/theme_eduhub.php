...
$string['static_page_header_image'] = 'Static page page header image';
$string['static_page_header_image_desc'] = 'The image to display as a header for the static page page.';
$string['static_page_url'] = 'Static page url';
$string['static_page_url_desc'] = 'Add the static page url without space, example: <b>/your-page-url</b>.';
...
$string['static_page_override_container_desc'] = 'This will remove the default content inside the <b>#page</b>. <br>If not, the frontpage container will be used here.';